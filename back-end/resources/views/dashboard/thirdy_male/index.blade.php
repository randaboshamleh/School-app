...
<div class="container mt-5">
    <h3 class="mb-4 text-center">🎓لوحة موجه الابتدائي ذكور</h3>

    {{-- معلومات عن الموجه --}}
    <div class="card mb-4 shadow-sm">
        <div class="card-body">
            <h5 class="card-title">الموجه: {{ auth()->user()->name }}</h5>
            <p class="card-text">يشرف على جميع الطلاب من الصف التاسع إلى البكالوريا</p>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-light">
            <h5 class="mb-0">👩‍🎓 الطلاب ضمن إشراف الموجه</h5>
        </div>
        <div class="card-body p-0">
            <table class="table table-striped text-center mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="5">لا توجد طلاب حالياً</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
